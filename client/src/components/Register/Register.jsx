    ...
    <div className={classes.container}>
      ...
      <div className={classes.formWrapper}>
        <div className={classes.formWrapper__form}>
          <div>
            <h2 className={classes.title}>Choose a Register Method</h2>
          </div>
          <div className={classes.methodWrapper}>
            <div className={classes.methodWrapper__social}>
              <div
                onClick={socialRegister.bind(null, googleProvider)}
              ...
              <div
                onClick={socialRegister.bind(null, facebookProvider)}
              ...
              <div
                onClick={socialRegister.bind(null, githubProvider)}
