...
const Login = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const { createdAt, email, password, updatedAt, __v, ...others } =
        loginUser.data;
    ...
    <div className={classes.container}>
      ...
      <div className={classes.formWrapper}>
        <div className={classes.formWrapper__form}>
          <div>
            <h2 className={classes.title}>Choose a Login Method</h2>
          </div>
          <div className={classes.methodWrapper}>
            <div className={classes.methodWrapper__social}>
              <div
                onClick={socialLogin.bind(null, googleProvider)}
                className={classes.google}
              >
                <img
                  className={classes.methodWrapper__social__img}
                  src={Google}
                  alt=""
                />
              ...
              <div
                onClick={socialLogin.bind(null, facebookProvider)}
              ...
              >
                <img
                  ...
                  alt=""
                />
                <h4 className={classes.methodWrapper__social__name}>
                  Facebook
                </h4>
              </div>
              <div
                onClick={socialLogin.bind(null, githubProvider)}
            ...
            <form
              className={classes.methodWrapper__data}
